...
const SendEnquiryButton: React.FC<SendEnquiryButtonProps> = ({
    ...
    return (
        <button
            className={`send-enquiry-button ${isSubmitting ? 'sending' : ''} ${className || ''}`}
        ...
        >
            ...
            <div className="state state--default">
                ...
                <p>
                    ...
                    <span style={{ '--i': 6 } as React.CSSProperties}>q</span>
                    ...
                    <span style={{ '--i': 10 } as React.CSSProperties}>y</span>
                </p>
            </div>
