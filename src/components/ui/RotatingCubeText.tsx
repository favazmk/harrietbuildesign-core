...
const RotatingCubeText = () => {
  ...
  return (
    <h1 className="flex flex-col w-full mb-8 pt-4 items-start gap-y-4">
      {/* Line 1: Left aligned */}
      <div className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal tracking-tight text-harriet-700 whitespace-nowrap text-left">
        Build a Home That
      </div>

      {/* Line 2: Left aligned */}
      <div className="flex flex-wrap justify-start items-center gap-4 sm:gap-6 font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal tracking-tight text-harriet-700 -mt-2">
